                        ...
                        loading ?
                          ...
                          <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 xl:gap-x-8">
                          {
                            books.map((book) => {
                              ...
                              return (
                                <div className="max-w-sm rounded-3xl overflow-hidden shadow-lg relative cursor-pointer transform transition duration-300 ease-in-out hover:scale-105">
                                  <div className='relative'>
                                  ...
                                  <div className="absolute bottom-0 left-0 right-0 bg-white p-4 rounded-xl">
                                    ...
                                    <div className="flex justify-center">
                                      <button className="w-full bg-black hover:bg-opacity-80 text-white font-bold py-2 px-4 rounded-xl focus:outline-none">
                                        {"Louer"}
                                      </button>
                                    </div>
